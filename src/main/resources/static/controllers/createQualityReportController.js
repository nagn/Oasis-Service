oasisApp.controller('createQualityReportController', ['$scope', '$state', 'loginService', 'waterReportService',
...
function($scope, $state, loginService, waterReportService) {
    ...
    $scope.overallConditions = ['Safe', 'Treatable', 'Unsafe'];
    ...
    $scope.save = function () {
        waterReportService.saveWaterQuality($scope.newReport).then(function (success) {
